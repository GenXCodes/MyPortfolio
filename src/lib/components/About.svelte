...
<section id="about" bind:this={sectionEl} class:visible>
  <div class="container">
    <div class="left">
      ...
      <div class="bio">
        <p>
          Hey! I'm <strong>Reckie Degollacion</strong>, a tech professional
          passionate about building reliable digital systems. I bridge the gap
          between end-users and complex technology — whether that's developing
          web applications, managing MSP support environments, or crafting
          intelligent AI automation workflows.
        </p>
        <p>
          With hands-on experience in IT infrastructure, modern web frameworks,
          and AI tooling, I approach every problem with both technical precision
    ...
    <div class="right">
      ...
      <div class="profile-card">
        <div class="avatar-wrapper">
          ...
          <!-- <img src="/your-photo.jpg" alt="Reckie Degollacion" class="avatar-img" /> -->
        </div>

        <div class="card-info">
          <p class="card-name">Reckie Degollacion</p>
      ...
      <div class="code-deco" aria-hidden="true">
        ...
        <span class="c-str"> "Building things"</span><span class="c-op">,</span
        ><br />
