  ...
  const projects = [
    {
      ...
      desc: 'Enterprise-grade ITAM platform featuring Role-Based Access, complete asset lifecycle & Chain of Custody tracking. Includes diff-based audit logs, auto-generated PDF accountability forms, bulk CSV/XLS import/export, KPI dashboards, secure authentication workflows, and an integrated AI Assistant.',
      tags: ['PHP 8.3', 'MySQL', 'Tailwind', 'Alpine.js', 'Dompdf', 'AI Assistant'],
      category: 'web',
      status: 'live',
      link: 'https://itamaecom.infinityfree.me/',
      github: '#',
      accent: '#00ff9d',
    },
    {
    ...
    {
      id: 7,
      title: 'SN AI Resolver V2',
      desc: 'Chrome Extension MV3 automating ServiceNow workflows. Built with Vanilla JS and background service workers to interface with Anthropic, DeepSeek, and Gemini for bulk ticket creation and resolution.',
      tags: ['Chrome Extension', 'Vanilla JS', 'ServiceNow API', 'LLM Integration'],
      category: 'automation',
      status: 'live',
      link: '#',
      github: '#',
        ...
        <article class="card" style="--card-accent: {project.accent}; animation-delay: {i * 0.08}s">
          <div class="card-top">
            ...
            <div class="card-links">
              <a href={project.github} aria-label="GitHub" title="View code" target="_blank" rel="noopener noreferrer">
              ...
              <a href={project.link} aria-label="Live demo" title="View live" target="_blank" rel="noopener noreferrer">
